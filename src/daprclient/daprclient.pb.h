...
#ifndef PROTOBUF_INCLUDED_daprclient_2eproto
#define PROTOBUF_INCLUDED_daprclient_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_daprclient_2eproto 
...
class CloudEventEnvelope : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:daprclient.CloudEventEnvelope) */ {
 ...
 private:
  ...
  friend struct ::protobuf_daprclient_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
#endif  // PROTOBUF_INCLUDED_daprclient_2eproto
